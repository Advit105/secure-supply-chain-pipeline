# GitHub Actions OIDC federation: CI assumes this role via its ambient workflow
# identity — no long-lived AWS access keys anywhere. Same trust model as the
...
data "aws_iam_policy_document" "github_trust" {
  statement {
    ...
    condition {
      # Only main-branch runs of THIS repo can assume the role.
      test     = "StringLike"
